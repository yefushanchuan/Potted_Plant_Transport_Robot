...
def generate_launch_description():
    ...
    nav2_rewritten_yaml = RewrittenYaml(
        ...
        param_rewrites={
            ...
            "bt_navigator.ros__parameters.default_nav_to_pose_bt_xml": PathJoinSubstitution(
                [pkg_robot_bringup, "config", "navigation", "navigate_to_pose.xml"]
            ),
        },
        convert_types=True,
    )
    ...
    default_nav2_params = PathJoinSubstitution([pkg_robot_bringup, "config", "navigation", "Nav_DWB_simple.yaml"])
