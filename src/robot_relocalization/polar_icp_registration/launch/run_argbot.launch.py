...
def _launch_setup(context):
    ...
    polar_icp_params_file = os.path.join(
    ...
    return [
        ...
        Node(
            ...
            name='polar_icp_registration_node',
            output='screen',
            condition=IfCondition(LaunchConfiguration('enable_polar_icp')),
            parameters=[
                polar_icp_params_file,
                {
...
def generate_launch_description():
    return LaunchDescription([
        ...
        DeclareLaunchArgument('enable_polar_icp', default_value='true', description='Whether to launch polar_icp_registration node'),
        DeclareLaunchArgument('keyframe_db', default_value='', description='Path to keyframe database directory (empty = single map mode)'),
