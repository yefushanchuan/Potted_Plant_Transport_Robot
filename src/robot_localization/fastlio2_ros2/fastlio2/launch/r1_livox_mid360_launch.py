...
def generate_launch_description():
    ...
    config_path = PathJoinSubstitution(
        [FindPackageShare("fastlio2"), "config", "r1_livox_mid360.yaml"]
    )

    # bag_file_path = "/home/wz/ros2_test_ws/src/fastlio2_ros2/bag/LIVOX_Points/R1/rosbag2_2025_11_13-13_41_13/rosbag2_2025_11_13-13_41_13_0.db3"  # r1办公室数据集
    ...
    return launch.LaunchDescription(
        [
            ...
            launch_ros.actions.Node(
                ...
                output="screen",
                parameters=[{
                    "config_path": "/home/wz/ros2_test_ws/install/fastlio2/share/fastlio2/config/r1_livox_mid360.yaml",
                     "use_sim_time": True
                }]
            ),
            # 启动 RViz2
