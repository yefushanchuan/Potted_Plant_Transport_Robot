...
def generate_launch_description():
    ...
    config_path = PathJoinSubstitution(
        [FindPackageShare("fastlio2"), "config", "airy_96.yaml"]
    )

    # bag_file_path = "/home/wz/ros2_test_ws/src/fastlio2_ros2/bag/RS16 bag/nap/nap_0.db3"  # 请修改为你自己的 bag 文件路径

    return launch.LaunchDescription(
        [
            # # 播放 rosbag（带仿真时间，20倍速）
            # launch.actions.ExecuteProcess(
            #     cmd=["ros2", "bag", "play", bag_file_path, "--clock", "--rate", "20.0"],
            #     output="screen"
            # ),
